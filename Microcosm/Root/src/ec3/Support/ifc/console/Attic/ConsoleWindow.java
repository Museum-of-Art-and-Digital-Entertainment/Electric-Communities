 ...
 * "java ec.ifc.console.ConsoleWindowTester"
 */
public class ConsoleWindow extends ECWindowController implements EventProcessor {
  ...
  public static final int WINDOW_MARGIN = 5;

  /** Margin separating bottom of window from bottom of screen */
  public static final int SCREEN_BOTTOM_MARGIN = 36;

  /** Minimal height for window at creation time */
  public static final int MINIMUM_HEIGHT = 146;
  ...
  protected static final String PRESENT_COMMAND = "PRESENT COMMAND";
  ...
  /*
   * Overridden to create and return a new window if necessary.
   */
  public Window getWindow() {
    ...
    myWindow.setTitle(DEFAULT_WINDOW_TITLE);

    Size windowSize =
      myWindow.windowSizeForContentSize(contentWidth, contentHeight);
    myWindow.setBounds(WINDOW_X, WINDOW_Y, windowSize.width, windowSize.height);
    ...
    iInputText = new TextField(MARGIN, (2 * MARGIN) + OUTPUT_HEIGHT,
  ...
  public void processEvent(Event event) {
    // make sure window exists, but not necessarily on screen
    getWindow();
