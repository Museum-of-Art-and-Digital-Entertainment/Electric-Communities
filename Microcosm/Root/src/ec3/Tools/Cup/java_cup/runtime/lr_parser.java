...
public abstract class lr_parser {
  ...
  public void syntax_error(token cur_token)
    {
      String msg = "Syntax error at line #" + cur_token.line_number;
      report_error(msg, cur_token);
    }
  ...
  public void unrecovered_syntax_error(token cur_token)
    throws java.lang.Exception
    {
      String msg = "Couldn't repair and continue parse at line #" + 
                    cur_token.line_number;
      report_fatal_error(msg, cur_token);
    }
