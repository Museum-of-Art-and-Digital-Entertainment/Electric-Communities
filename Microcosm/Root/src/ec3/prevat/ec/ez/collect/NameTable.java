...
public interface NameTable {
    ...
    /**
     * Variation on get that returns null if no name found
     */
    ...
    /**
     * Version of sprout that flags this level of the NameTable as permitting
     * redefinition if the redefOK flag is set.
     */
