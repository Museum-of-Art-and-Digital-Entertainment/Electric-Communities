/* 
   ...
   first, start the listener:
       java ec.e.start.EBoot ec.examples.hc.HelloComm reg=<file_for_SturdyRef>

   then, start the sender:
       java ec.e.start.EBoot ec.examples.hc.HelloComm lookup=<file_for_SturdyRef>
   ...
   first, start the listener:
       java ec.e.start.EBoot ec.examples.hc.HelloComm reg=<file_for_SturdyRef> ListenAddr=<listener_address>

   then, start the sender:
       java ec.e.start.EBoot ec.examples.hc.HelloComm lookup=<file_for_SturdyRef> ListenAddr=<sender_address>
...
eclass HelloReceiver {
    ...
    HelloReceiver(Registrar registrar, SturdyRefMaker refMaker, SturdyRefFileExporter refExporter, String reg) {
        try {
            ...
            EStdio.out().println("Receiver: run   java ec.e.start.EBoot ec.examples.hc.HelloComm lookup=" + reg);
        } catch (Throwable t) {
