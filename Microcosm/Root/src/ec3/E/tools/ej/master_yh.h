...
YH_DEF(attribute_info,
  YH_FLD_WORD(attribute_name_index)
  YH_FLD_LONG(attribute_length)
  YH_FLD_PRIMA(info,byte)
  ,
  YH_ARG_FIELD(attribute_name_index)
  YH_ARG_FIELD(attribute_length)
  YH_ARG_FIELD(info)
)

YH_DEF(classFile,
  YH_FLD_LONG(magic)
  YH_FLD_WORD(minor_version)
  YH_FLD_WORD(major_version)
  YH_FLD_WORD(constant_pool_count)
  YH_FLD_PTRA(constant_pool,cp_info)
  YH_FLD_WORD(access_flags)
  YH_FLD_WORD(this_class)
  YH_FLD_WORD(super_class)
  YH_FLD_WORD(interfaces_count)
  YH_FLD_PRIMA(interfaces,word)
  YH_FLD_WORD(fields_count)
  YH_FLD_PTRA(fields,field_info)
  YH_FLD_WORD(methods_count)
  YH_FLD_PTRA(methods,method_info)
  YH_FLD_WORD(attributes_count)
  YH_FLD_PTRA(attributes,attribute_info)
  ,
  YH_ARG_FIELD(magic)
  YH_ARG_FIELD(minor_version)
  YH_ARG_FIELD(major_version)
  YH_ARG_FIELD(constant_pool_count)
  YH_ARG_FIELD(constant_pool)
  YH_ARG_FIELD(access_flags)
  YH_ARG_FIELD(this_class)
  YH_ARG_FIELD(super_class)
  YH_ARG_FIELD(interfaces_count)
  YH_ARG_FIELD(interfaces)
  YH_ARG_FIELD(fields_count)
  YH_ARG_FIELD(fields)
  YH_ARG_FIELD(methods_count)
  YH_ARG_FIELD(methods)
  YH_ARG_FIELD(attributes_count)
...
YH_DEF_TAGGED(constant_utf8_info,
  YH_FLD_WORD(length)
  YH_FLD_PRIMA(bytes,byte)
  ,
  YH_ARG_FIELD(length)
  YH_ARG_FIELD(bytes)
)
...
YH_DEF(activePackage,
  YH_FLD_PTR(packageName,name)
  YH_FLD_PTR(table,classTable)
  ,
  YH_ARG_FIELD(packageName)
  YH_ARG_FIELD(table)
)
YH_LIST_DEF(activePackage)
...
YH_DEF(classTable,
  YH_FLD_PTRA(bucketsFQN,classBucketEntry)
  YH_FLD_PTRA(bucketsUnqual,classBucketEntry)
  YH_FLD_LONG(count)
  YH_FLD_PTR(next,classTable)
  ,
  YH_ARG_FIELD(bucketsFQN)
  YH_ARG_FIELD(bucketsUnqual)
  YH_ARG_FIELD(count)
  YH_ARG_FIELD(next)
)

YH_DEF(fileImport,
  YH_FLD_PTR(className,string)
  YH_FLD_BOOL(isEClass)
  ,
  YH_ARG_FIELD(className)
  YH_ARG_FIELD(isEClass)
)
YH_LIST_DEF(fileImport)
...
YH_DEF(unitInfo,
  YH_FLD_PTR(packageName,name)
  YH_FLD_PTR(importedClasses,classTable)
  YH_FLD_PTR(packageClasses,classTable)
  ,
  YH_ARG_FIELD(packageName)
  YH_ARG_FIELD(importedClasses)
  YH_ARG_FIELD(packageClasses)
)
