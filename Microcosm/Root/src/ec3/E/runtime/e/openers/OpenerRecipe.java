...
public final class OpenerRecipe extends Recipe {
     ...
     */
    private TableEditor myEncoderMakers;

    /**
     * Maps Classes to RefOpeners for encoding instances of that
     * Class.
     */
    private TableEditor myEncoders;
    ...
    public OpenerRecipe(String[][] decoderMakers,
        ...
        myDecoderMakers = new TableEditorImpl(JavaUtil.STRING_TYPE,
                                    JavaUtil.STRING_TYPE);
        myDecoderMakers.putPairs(decoderMakers, true);
        myDecoders = new TableEditorImpl(OpenerID.OPENER_ID_TYPE,
                               ObjOpener.OBJ_OPENER_TYPE);

        myEncoderMakers = new TableEditorImpl(JavaUtil.STRING_TYPE,
                                    JavaUtil.STRING_TYPE);
        myEncoderMakers.putPairs(encoderMakers, true);
        myEncoders = new TableEditorImpl(true,
                               JavaUtil.CLASS_TYPE,
                               ObjOpener.OBJ_OPENER_TYPE);
           ...
           IllegalAccessException
    {
        ...
        if (encMakerName != null) {
            ...
            Recipe encoder = (Recipe)maker.invoke(null, NO_ARGS);
            //wrap
