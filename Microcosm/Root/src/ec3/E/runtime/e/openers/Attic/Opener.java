...
/** 
 * The file Opener.java started out as ECReflect.java, attempting to
 * mimic the functionality in the Jave 1.1. Reflection API, but became
 * a capability-based set of abstractions for inspecting, encoding, &
 * decoding sets of objects.  <p> 
 *
...
public abstract class Opener {
    ...
    static public final int MIN_OPENER_LIBRARY_VERSION = 200;
    static public final int RELEASED_OPENER_LIBRARY_VERSION = 200;
    static public final int MAX_OPENER_LIBRARY_VERSION = 200;
    ...
    public static void staticSelfTest() {
        int foundVersion = libraryVersion();

        if (foundVersion < MIN_OPENER_LIBRARY_VERSION) 
            throw new Error("Opener native library is version " + foundVersion +
                            ", please upgrade to " + RELEASED_OPENER_LIBRARY_VERSION);

        if (foundVersion > MAX_OPENER_LIBRARY_VERSION) 
            throw new Error("Opener native library is version " + foundVersion +
                            ", but system cannot use later than " + MAX_OPENER_LIBRARY_VERSION);
    }

    static public final Opener BOOLEAN  = new BooleanOpener();
    static public final Opener BYTE     = new ByteOpener();
    static public final Opener CHAR     = new CharOpener();
    static public final Opener SHORT    = new ShortOpener();
    static public final Opener INT      = new IntOpener();
    static public final Opener LONG     = new LongOpener();
    static public final Opener FLOAT    = new FloatOpener();
    static public final Opener DOUBLE   = new DoubleOpener();
    ...
    /**
     * Returns a Class for the type that this Opener opens.  If this
     * is an Opener for a scalar type, this will return the
    ...
    /**
     * Signatures are according to the Java Virtual Machine Specification.
     */
    public abstract String signature();

    /**
     * Encode 'obj' onto 'encoder' according to the type this Opener
     * describes.  Unwraps 'obj' as necessary.
     *
     * @param obj nullOk, suspect;
     * @param encoder suspect;
     */
    public abstract void encodeItTo(Object obj, RtEncoder encoder)
         throws IOException;

    /**
     * Decode an object from 'decoder' according to the type this Opener
     * describes.  Wraps result as necessary.
     *
     * @param decoder suspect;
     * @return nullOk, suspect;
     */
    public abstract Object decodeFrom(RtDecoder decoder)
         throws IOException;
 ...
 */
final class BooleanOpener extends Opener {
    ...
    public void encodeItTo(Object obj, RtEncoder encoder) throws IOException {
        encoder.writeBoolean(((Boolean)obj).booleanValue());
    }
    
    public Object decodeFrom(RtDecoder decoder) throws IOException {
 ...
 */
final class ByteOpener extends Opener {
 ...
 */
final class CharOpener extends Opener {
 ...
 */
final class ShortOpener extends Opener {
 ...
 */
final class IntOpener extends Opener {
 ...
 */
final class LongOpener extends Opener {
 ...
 */
final class FloatOpener extends Opener {
 ...
 */
final class DoubleOpener extends Opener {
