...
/**
  A capability class providing read/write access to a file. Wraps Java's
  RandomAccessFile class by only providing read and write access while
  withholding the power to open a file. Also deals with quakes by holding onto
  the file via a tether.
*/
public class EFileEditor extends EFileReader implements DataOutput {
    /**
    * Construct an EFileEditor given a file. Only called within the package,
    * by EEditableFile.
    *
    ...
    */
    EFileEditor(Vat vat, File file) throws IOException {
        super(vat, file, "rw");
    }
