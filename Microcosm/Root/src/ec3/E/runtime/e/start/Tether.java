 ...
 * (Thanks Dan!) <p>
 *
 * @see ec.e.start.Vat#makeSturdyLeaf 
 */
public class Tether {
    private Vat myVat;
    ...
    /**
     * Construct a pre-smashed Tether
     */

    public Tether(Vat vat) {
        myVat = vat;
        myBirthQuake = -1;
        myHeld = null;
    }
     ...
     *
     * @see ec.e.start.Tether#reconstructed
     * @return suspect nullOk
     */
...
/**
 * A Tether that is unaffected by a quake-drill.  Used for sturdy leafs.
 */
...
/**
 * A Tether whose held() value can be set, and which survives
 * quake-drills. 
 */
public class SettableTether extends SimplySturdyTether {
    
    /**
     * @param held suspect nullOk
     */
    public SettableTether(Vat vat, Object held) {
        super(vat, held);
    }
 ...
 * fashion.
 *
 * @see ec.e.start.Vat#makeFragileRoot
 */
public final class FragileRootHolder extends Tether implements RtFinalizer {
     ...
     * @param key nullOk
     */
    FragileRootHolder(Vat vat, Object held, Object key) {
        super(vat, held);
        myKey = key;
    }
