...
public class ENetAddr {
     ...
     */
    // XXX was protected
    public ENetAddr(InetAddress ip, int portNumber) {
        myInetAddress = ip;
 ...
 */
public class ENetAddrLocal extends ENetAddr {
    /**
     ...
     */
    public ENetAddrLocal(int portNumber) {
 ...
 */
public class ENetAddrRemote extends ENetAddr {
    /**
     * Construct a remote address given an IP address and port.
     */
    public ENetAddrRemote(InetAddress ip, int portNumber) {
        super(ip, portNumber);
    }
}
