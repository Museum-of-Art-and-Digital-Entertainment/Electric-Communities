...
public class RtStandardEncoder implements RtEncoder {
    ...
    public RtStandardEncoder (RtEncodingManager ship, TypeTable table, 
                              ...
                              Hashtable strings) {
        this(ship, table, null, null, null, useSpecialDataStream, strings);
    }
    ...
    public RtStandardEncoder (RtEncodingManager ship, TypeTable table,
                              ...
                              boolean useSpecialDataStream,
                              Hashtable strings) {
        this(ship, table, parameters, properties, null, useSpecialDataStream, strings);
    }
    ...
    public RtStandardEncoder (RtEncodingManager ship, TypeTable table,
        ...
        if (useSpecialDataStream) {
            os = new RtEncoderDataOutputStream(stream, myStrings);
        } else {
    ...
    public void encodeObject (Object object) throws IOException {
        ...
        boolean encodedRoot = false;

        if (encodingRoot == false) {
        ...
        if (managerWillEncode) {
            ...
            if (objectWillEncode) {
                ...
                if (needToEncode) {
                    ...
                    os.writeByte((byte)(endpos>>24));
                    os.writeByte((byte)(endpos>>16));
                    os.writeByte((byte)(endpos>>8));
                    os.writeByte((byte)(endpos));
                    if (tr.tracing) {
