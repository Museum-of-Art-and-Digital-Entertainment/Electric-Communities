...
final class RtSpecialCoder implements RtSpecialObjectCoder {
    ...
    static void initialize () {
        ...
        try {
            ...
            RtCodingSystem.registerSpecialCodingClass(Properties.class, theSpecialCoder,
    ...
    public void encodeSpecialObject (Object object, Class theClass, Object arg, RtEncoder stream) {
        int i;
        int size;
        ...
        case kObjectArrayClass:
            if (tr.debug && Trace.ON) tr.$("Called to encode Object Array of size " + ((Object[])object).length);
            try {
