...
public class IFCWebFramework extends ECApplication implements WebFramework
{
    private EEnvironment env;
    
    IFCWebFramework (EEnvironment env) {
        this.env = env;
    }
    public WebController getWebController() {
        return new IFCWebController(env, this);
    }
}

public class IFCWebFactory implements UIFrameworkOwner
{
    private IFCWebFramework runner;
    ...
    public UIFramework framework (EEnvironment env) {
        innerFramework(env);
        return new WebFrameworkSteward(env, runner);
    }

    public Object innerFramework (EEnvironment env) {
        runner = new IFCWebFramework(env);
        return runner;
    }
...
public class IFCWebController implements Target, EventProcessor, WebController, TextViewOwner, TextFilter, ECTipViewOwner {
    ...
    IFCWebController (EEnvironment env, ECApplication application) {
        this.env = env;
